...
/*
  ...
  wire m_axi_lite_debug_arready;
  wire m_axi_lite_debug_arvalid;
  wire [31:0]m_axi_lite_debug_awaddr;
  wire [2:0]m_axi_lite_debug_awprot;
  wire m_axi_lite_debug_awready;
  wire m_axi_lite_debug_awvalid;
  wire m_axi_lite_debug_bready;
  wire [1:0]m_axi_lite_debug_bresp;
  wire m_axi_lite_debug_bvalid;
  wire [31:0]m_axi_lite_debug_rdata;
  wire m_axi_lite_debug_rready;
  wire [1:0]m_axi_lite_debug_rresp;
  wire m_axi_lite_debug_rvalid;
  wire [31:0]m_axi_lite_debug_wdata;
  wire m_axi_lite_debug_wready;
  wire [3:0]m_axi_lite_debug_wstrb;
  wire m_axi_lite_debug_wvalid;
  
  assign m_axi_lite_debug_wstrb = '1;
  assign m_axi_lite_rresp = '0;
  assign m_axi_lite_bresp = '0;
 ...
 #(.width_p(32))
  ...
  (.clk_i  (pcie_clk)
  ,.reset_i(~pcie_rstn)
  ,.v_i    (m_axi_lite_arvalid)
  ,.data_i (m_axi_lite_araddr)
  ,.ready_o(m_axi_lite_arready)
  ,.v_o    (m_axi_lite_debug_arvalid)
  ,.data_o (m_axi_lite_debug_araddr)
  ,.yumi_i (m_axi_lite_debug_arvalid & m_axi_lite_debug_arready)
  );
 ...
 #(.width_p(32))
  ...
  (.clk_i  (pcie_clk)
  ,.reset_i(~pcie_rstn)
  ,.v_i    (m_axi_lite_awvalid)
  ,.data_i (m_axi_lite_awaddr)
  ,.ready_o(m_axi_lite_awready)
  ,.v_o    (m_axi_lite_debug_awvalid)
  ,.data_o (m_axi_lite_debug_awaddr)
  ,.yumi_i (m_axi_lite_debug_awvalid & m_axi_lite_debug_awready)
  );
 ...
 #(.width_p(32))
  ...
  (.clk_i  (pcie_clk)
  ,.reset_i(~pcie_rstn)
  ,.v_i    (m_axi_lite_wvalid)
  ,.data_i (m_axi_lite_wdata)
  ,.ready_o(m_axi_lite_wready)
  ,.v_o    (m_axi_lite_debug_wvalid)
  ,.data_o (m_axi_lite_debug_wdata)
  ,.yumi_i (m_axi_lite_debug_wvalid & m_axi_lite_debug_wready)
  );
 ...
 #(.width_p(32))
  ...
  (.clk_i  (pcie_clk)
  ,.reset_i(~pcie_rstn)
  ,.v_i    (m_axi_lite_debug_rvalid)
  ,.data_i (m_axi_lite_debug_rdata)
  ,.ready_o(m_axi_lite_debug_rready)
  ,.v_o    (m_axi_lite_rvalid)
  ,.data_o (m_axi_lite_rdata)
  ,.yumi_i (m_axi_lite_rvalid & m_axi_lite_rready)
  );
 ...
 #(.width_p(32))
  ...
  (.clk_i  (pcie_clk)
  ,.reset_i(~pcie_rstn)
  ,.v_i    (m_axi_lite_debug_bvalid)
  ,.data_i ('0)
  ,.ready_o(m_axi_lite_debug_bready)
  ,.v_o    (m_axi_lite_bvalid)
  ,.data_o ()
...
*/
  ...
  bsg_manycore_link_sif_s links_sif_pcie_li, links_sif_pcie_lo;
 ...
 #(.addr_width_p   ( manycore_addr_width_gp )
  ...
  (.L_clk_i        ( pcie_clk )
  ,.L_reset_i      ( ~pcie_rstn )
  ,.L_link_sif_i   ( links_sif_pcie_lo )
  ,.L_link_sif_o   ( links_sif_pcie_li )
  ,.R_clk_i        ( mig_clk )
  ,.R_reset_i      ( mig_reset )
  ,.R_link_sif_i   ( links_sif_li )
  ,.R_link_sif_o   ( links_sif_lo )
  );
