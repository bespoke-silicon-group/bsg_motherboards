...
cmd_map = { 'CMD_VER':0x00,
            ...
            'CMD_PLL_SET_CONTROL':0x50,
            'CMD_PLL_SET_IO_OSC':0x51,
            'CMD_PLL_SET_IO_DIV':0x52,
            'CMD_PLL_SET_IO_ISDIV':0x53,
            'CMD_PLL_SET_CORE_OSC':0x54,
            'CMD_PLL_SET_CORE_DIV':0x55,
            'CMD_PLL_SET_CORE_ISDIV':0x56,
            'CMD_NOP':0xAA }
